...
write_csv(manybabies_merged, "manybabies_merged.csv", na = "NA")
```
...
```{r}
merged_manybabies_final <- merged_manybabies %>%       
  filter(!looking_time %in% c(41852, 41518, 751, 472))
```
This new dataset was exported as a new cvs file called merged_manybabies_final. 
