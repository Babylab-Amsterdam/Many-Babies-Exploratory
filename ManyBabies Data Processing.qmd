...
a. **Stimulus identifier**. MB1 contains `stimulus_num` , MB2 contains `stimulus_filename` , while MB4 does not contain one specific variable indicating the specific stimulus for each trial. For MB4, the variable can be created by merging the content of the variables `push_up_identity`, `push_up_order`, `push_up_side`.\
